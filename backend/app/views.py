...
from .serializers import PlanoSerializer, ComissaoPlanoSerializer, ClienteSerializer, ConsultorSerializer, VendaSerializer, ControleRecebimentoSerializer, ExtratoPlataformaSerializer
